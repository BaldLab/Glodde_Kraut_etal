...
read.data.pie <- function(working.dir = "Polyclonal_cell_lines/",
                          input.dir = "statistics/",
...
indel.position <- function(working.dir = "Polyclonal_cell_lines/",
                           input.dir = "cell_line_indel_pos_tables/",
                           Exp.ID = "MH3", 
                           output.dir = "results/"){
...
read.data.tumor.clonality <- function(working.dir = "RM1_B16/", 
                                      input.dir = "Mutation_tables/",
...
file.path <- read.data.pie(working.dir = "Polyclonal_cell_lines/", 
                           input.dir = "statistics/",
                           pattern.var = "Mutation_stats.txt",
                           output.dir = "results/")
...
indel.position(working.dir = "Polyclonal_cell_lines/",
               input.dir = "cell_line_indel_pos_tables/", 
               Exp.ID = "MH3")
...
file.path <- read.data.pie(working.dir = "Pre_injection_samples/", 
                           input.dir = "statistics/",
...
input.data <- read.data.tumor.clonality(working.dir = "RM1_B16/", 
                                        input.dir = "Mutation_tables/",
                                        pattern.var.tumor = "Kif18b_mutation_table.txt",
                                        pattern.var.KO = "Pmel_mutation_table.txt",
                                        output.dir = "results/")
...
input.data <- read.data.tumor.clonality(working.dir = "RM1_and_RM5_together_B16/", 
                                        input.dir = "Mutation_tables/",
                                        pattern.var.tumor = "Kif18b_mutation_table.txt",
                                        pattern.var.KO = "Pmel_mutation_table.txt",
                                        output.dir = "results/")
...
input.data <- read.data.tumor.clonality(working.dir = "RM2_HC12_Single_conditions/", 
                                        input.dir = "Mutation_tables/",
...
input.data <- read.data.tumor.clonality(working.dir = "RM3_B16_Single_conditions/", 
                                        input.dir = "Mutation_tables/",
                                        pattern.var.tumor = "Kif18b_mutation_table.txt",
...
input.data <- read.data.tumor.clonality(working.dir = "RM5_B16/", 
                                        input.dir = "Mutation_tables/",
                                        pattern.var.tumor = "Kif18b_mutation_table.txt",
                                        pattern.var.KO = "Pmel_mutation_table.txt",
                                        output.dir = "results/")
...
input.data <- read.data.tumor.clonality(working.dir = "RM6_HC12_OE/", 
                                        input.dir = "Mutation_tables/",
